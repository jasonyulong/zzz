...
!function(a) {
    ...
    return function() {
        ...
        //Please enter a value with a valid mimetype.(请用有效的MIMETYPE输入一个值)
        ...
        //Letters, numbers, and underscores only please(请只填写字母、数字和下划线)
        a.validator.addMethod("alphanumeric", function(a, b) {
            return this.optional(b) || /^\w+$/i.test(a)
        }, "Letters, numbers, and underscores only please"),
        //Please enter a value with a valid mimetype.(请指定有效的银行账号)
        ...
        //Please specify a valid bank or giro account number.(请指定一个有效的银行或帐号)
        a.validator.addMethod("bankorgiroaccountNL", function(b, c) {
            return this.optional(c) || a.validator.methods.bankaccountNL.call(this, b, c) || a.validator.methods.giroaccountNL.call(this, b, c)
        }, "Please specify a valid bank or giro account number"),
        //Please specify a valid BIC code.(请指定有效的BIC代码)
        a.validator.addMethod("bic", function(a, b) {
            return this.optional(b) || /^([A-Z]{6}[A-Z2-9][A-NP-Z1-9])(X{3}|[A-WY-Z0-9][A-Z0-9]{2})?$/.test(a.toUpperCase())
        }, "Please specify a valid BIC code"),
        //Please specify a valid CIF number..(请指定一个有效的CIF号码)
        ...
        //Please specify a valid CPF number(请指定有效的CPF号码)
        ...
        a.validator.addMethod("nieES", function(a) {
            ...
            !(a.length > 10 || a.length < 9 || !c.test(a)) && (a = a.replace(/^[X]/, "0").replace(/^[Y]/, "1").replace(/^[Z]/, "2"),
        ...
        a.validator.addMethod("nifES", function(a) {
            ...
            !!a.match("((^[A-Z]{1}[0-9]{7}[A-Z0-9]{1}$|^[T]{1}[A-Z0-9]{8}$)|^[0-9]{8}[A-Z]{1}$)") && (/^[0-9]{8}[A-Z]{1}$/.test(a) ? "TRWAGMYFPDXBNJZSQVHLCKE".charAt(a.substring(8, 0) % 23) === a.charAt(8) : !!/^[KLM]{1}/.test(a) && a[8] === String.fromCharCode(64))
